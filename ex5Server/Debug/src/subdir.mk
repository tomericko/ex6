...
src/%.o: ../src/%.cpp
	...
	g++ -I"/home/tomericko/git/tomericko/ex5/ex5Server/include" -I"/home/tomericko/git/tomericko/ex5/ex5Server/include" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
